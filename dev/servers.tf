# create a new droplet in the var.region
resource "digitalocean_droplet" "assignment" {
...
resource "digitalocean_project_resources" "project_attach" {
  ...
  resources = flatten([digitalocean_droplet.assignment.*.urn])
}
...
resource "digitalocean_firewall" "web" {
    ...
    droplet_ids = digitalocean_droplet.assignment.*.id
